...
# #### Train model
model = train_model(model, criterion, optimizer, dataloaders, scheduler, dataset_sizes, num_epochs=20)

torch.save(model.state_dict(), 'models/model_{}.pth'.format(study_type))
print("Model for {} saved".format(study_type))
